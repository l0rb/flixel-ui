...
class FlxUI extends FlxUIGroup implements IEventGetter
{
	...
	private function _loadThing(type:String, data:Fast):IFlxUIWidget
	{
		...
		switch (type)
		{
			...
			case "failure":
				if (_failure_checks == null)
				{
					_failure_checks = new Array<Fast>();
				}
				unparentXML(info);
	...
	private function newUI(data:Fast = null, ptr:IEventGetter = null, superIndex_:FlxUI = null, tongue_:IFireTongue = null, liveFilePath_:String = "",
