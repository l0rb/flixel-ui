...
class FlxUI9SliceSprite extends FlxUISprite implements IResizable implements IFlxUIWidget
{
	...
	private function resizeWithSubSprites(iw:Int, ih:Int):Void
	{
		...
		for (i in 0...9)
		{
			...
			switch (i)
			{
				case 0:
					...
					piece.y = 0; // top left
				case 1:
					piece.x = iw - piece.width;
					piece.y = 0; // top right
				case 2:
					piece.x = pieces[0].width;
					piece.y = 0; // top
				case 3:
					piece.x = 0;
					piece.y = ih - piece.height; // bottom left
				case 4:
					piece.x = iw - piece.width;
					piece.y = ih - piece.height; // bottom right
				case 5:
					piece.x = pieces[3].width;
					piece.y = ih - piece.height; // bottom
				case 6:
					piece.x = 0;
					piece.y = pieces[0].height; // left
				case 7:
					piece.x = iw - piece.width;
					piece.y = pieces[1].height; // right
				case 8:
					piece.x = pieces[6].width;
					piece.y = pieces[2].height; // middle
			}
		}
		...
		if (_subSpriteTiles != null)
		{
			for (i in 0...5)
			{
				...
				{
					case 0:
						spanw = iw - pieces[0].width - pieces[1].width; // top
						tilesf = spanw / pw;
						hit = 1;
					...
					case 1:
						spanw = iw - pieces[3].width - pieces[4].width; // bottom
						tilesf = spanw / pw;
						hit = 1;
					...
					case 2:
						spanh = ih - pieces[0].height - pieces[3].height; // left
						tilesf = spanh / ph;
						wit = 1;
					...
					case 3:
						spanh = ih - pieces[1].height - pieces[4].height; // right
						tilesf = spanh / ph;
						wit = 1;
					...
					case 4:
						spanw = iw - pieces[0].width - pieces[1].width; // center
						tilesf = spanw / pw;
				...
				{
					case 0:
						tiles.x = pieces[2].x; // top
						tiles.y = pieces[2].y;

					case 1:
						tiles.x = pieces[5].x; // bottom
						tiles.y = ih - tiles.height;

					case 2:
						tiles.x = pieces[6].x; // left
						tiles.y = pieces[6].y;

					case 3:
						tiles.x = iw - tiles.width; // right
						tiles.y = pieces[7].y;

					case 4:
						tiles.x = pieces[8].x; // center
						tiles.y = pieces[8].y;
				}
			}
		}
	...
	{
		if (remainder == 0.0 && remainder2 == 0.0)
			return bmp;
	...
	public static function paintScale9(g:BitmapData, assetID:String, scale9:Array<Int>, rc:FlxRect, tile:Int = TILE_NONE, smooth:Bool = false,
			?raw:BitmapData, ?group:FlxSpriteGroup):String
	{
		if (scale9 != null)
		{ // create parts
	...
	public static function paintCompoundBitmap(g:BitmapData, assetID:String, sourceRects:Map<String, FlxRect>, targetRect:FlxRect, tile:Int = TILE_NONE,
			smooth:Bool = false, raw:BitmapData = null, group:FlxSpriteGroup = null):Void
	{
	...
	private static function _paintBitmapSection(g:BitmapData, assetId:String, src:FlxRect, dst:FlxRect, srcData:BitmapData = null, tile:Int = TILE_NONE,
			smooth:Bool = false, raw:BitmapData = null, group:FlxSpriteGroup = null, groupIndex:Int = -1):Void
	{
		if (srcData == null)
		{
			if (raw != null)
	...
	private static function bitmapFillRect(g:BitmapData, dst:Rectangle, section:BitmapData, tile:Int = TILE_NONE, smooth_:Bool = false,
			group:FlxSpriteGroup = null, groupIndex:Int = -1):Void
	{
