...
class FlxUIColorSwatchSelecter extends FlxUIGroup implements IFlxUIClickable
{
			...
			?Swatch:SwatchGraphic = null)
	{
		...
		_previewSwatch = makeSwatch(0, 0, null, new SwatchData("dummy", [0xffffffff, 0xff888888, 0xff444444, 0xff000000]), _previewGraphic.asset, null,
			_previewGraphic.width, _previewGraphic.height);
	...
	private function makeSwatch(X:Float, Y:Float, ?Color:Int = 0xFFFFFF, ?Colors:SwatchData, ?Asset:Dynamic, ?Callback:Void->Void, Width:Int = -1,
			Height:Int = -1)
	{
